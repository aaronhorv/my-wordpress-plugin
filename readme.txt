...
* Helps identify correct Device ID to use

= 1.2.0 =
* Added debug section to Settings page showing connection status and test results
* Shows current position, route test, and trip cache info
